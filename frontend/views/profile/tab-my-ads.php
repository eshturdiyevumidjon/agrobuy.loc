...
<div class="tab-my-ads">
    <div class="row">
    	<?php foreach ($myAdsdataProvider->getModels() as $ads) { 
            ...
            if($ads->top) $topClass = 'top_ads_class';
            else $topClass = '';
        ?>
        <div class="col-xl-3 col-lg-4 col-6">
            <div class="item-product no_active_ads <?=$topClass?>">
                <div class="dropdown-person three_point">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item premium_ads" href="#" data-touch="false" value="/<?=$nowLanguage?>/ads/premium?id=<?=$ads->id?>" data-fancybox data-src="#ad-promotion-tab" ><?=Yii::t('app', "Targ'ib qilish")?></a>
