            ...
            <div class="item-product">
                <div class="dropdown-person">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="#"><?= Yii::t('app',"E'lonni tahrirlash") ?></a>
                        <a class="dropdown-item" href="#"><?= Yii::t('app',"Rag'batlantirish") ?></a>
                        <a class="dropdown-item" href="#"><?= Yii::t('app',"Faollashtirish/O'chirish") ?></a>
                        <a class="dropdown-item" href="#"><?= Yii::t('app',"E'lonni o'chirish") ?></a>
                        <a class="dropdown-item" href="#"><?= Yii::t('app',"Mening katalogimga qo'shish/o'chiring") ?></a>
                    </div>
                </div>
                <a href="#">
