        ...
        <form action="" class="img-main-user" method="post" enctype="multipart/form-data">
          ...
          <div class="about-main-user">
            ...
            <div class="about-main-user-bottom mob-abs-right">
              <div>
                <p>Логин: <span><?=$identity->login?></span></p>
                <p>Название компании: <span><?=$identity->company_name?></span></p>
                <p>ID: <span><?=$identity->id?></span></p>
              </div>
              <div class="person-socials">
                <span class="first-person-socials">
                ...
                <span class="first-person-socials">PASS</span>
                <span class="first-person-socials">
                ...
                <span class="second-person-socials">
                  <!--?xml version="1.0" encoding="UTF-8"?-->
                  <svg enable-background="new 0 0 512 512" version="1.1" viewBox="0 0 512 512" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="about-main-user-right">
            ...
            <div class="my-catalog-block">
              <a href="#" class="btn-template link-btn">Мой каталог</a>
              <a href="#" class="btn-template link-btn">Мои чаты</a>
            </div>
            <div class="ratings">
              <b>Рейтинг:</b>
              <div class="progress">
                  <div class="progress-bar" role="progressbar" style="width: 80%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">0</div>
              </div>
            </div>
