        ...
        <form action="" class="img-main-user" method="post" enctype="multipart/form-data">
              ...
              <div class="person-socials">
                <span class="first-person-socials">
                  <!--?xml version="1.0" encoding="UTF-8"?-->
                    <svg enable-background="new 0 0 512.076 512.076" fill="red" version="1.1" viewBox="0 0 512.08 512.08" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="about-main-user-right">
            ...
            <div class="my-catalog-block">
              ...
              <a href="#" class="btn-template link-btn"><?= Yii::t('app',"Mening chatim") ?></a>
            </div>
            <div class="ratings">
