...
?>
    ...
    <?php foreach ($trustedAds as $ads) { 
        ...
        if($avt) {
            ...
            if($fav) {
                $star = '<img src="/images/star-full.png" alt="" id="remove_trusted-'.$ads->id.'" class="remove_star" lang="'.$nowLanguage.'">
                    <img src="/images/star-free.png" alt="" id="set_trusted-'.$ads->id.'" class="set_star" lang="'.$nowLanguage.'">';
            }
            else {
                $star = '<img src="/images/star-free.png" alt="" id="set_trusted-'.$ads->id.'" class="set_star" lang="'.$nowLanguage.'">
                    <img src="/images/star-full.png" alt="" id="remove_trusted-'.$ads->id.'" class="remove_star" lang="'.$nowLanguage.'">';
            }
        }
        else {
