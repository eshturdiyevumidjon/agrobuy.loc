          	...
          	<div class="col-lg-9 col-md-8 col-3 justify-content-end d-flex align-items-center">
            	...
            	<?php } else { ?>
              		<?php if(Yii::$app->controller->id == 'profile') { ?>
                		<a class="btn btn-template btn_exit" data-touch="false" data-fancybox data-src="#logout-popup" ><?=Yii::t('app', "Chiqish")?></a>
              		<?php } ?>
