      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <div class="ads-container">
              ...
              <div class="ads-container-bottom">
                <div class="address-item-product">
                  Пенза, Пензенская <br> область, Россия
                </div>
            ...
            <div class="ads-right">
              ...
              <div class="ads-user">
                ...
                <div class="bottom-block-reuters">
                  ...
                  <a href="tel:+ 7 (495) 998-78-65" class="link-template-img">
                    <span><!--?xml version="1.0" encoding="UTF-8"?-->
                  ...
                  <a href="#" class="link-template-img">
                    <span>
                      ...
                      <svg enable-background="new 0 0 469.333 469.333" version="1.1" viewBox="0 0 469.33 469.33" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
                            <path d="m206.88 43.544c-3.875-1.698-8.448-0.896-11.542 2.042l-109.85 103.75h-74.823c-5.896 0-10.667 4.771-10.667 10.666v149.33c0 5.896 4.771 10.667 10.667 10.667h74.823l109.85 103.75c2.021 1.917 4.656 2.917 7.323 2.917 1.427 0 2.865-0.281 4.219-0.875 3.917-1.677 6.448-5.531 6.448-9.792v-362.67c-1e-3 -4.261-2.532-8.115-6.449-9.792zm-14.885 347.71-94.948-89.667c-1.979-1.875-4.604-2.917-7.323-2.917h-68.396v-128h68.396c2.719 0 5.344-1.042 7.323-2.917l94.948-89.665v313.17z"></path>
                            <path d="m372.06 44.7c-4.813-3.469-11.469-2.385-14.896 2.375-3.458 4.771-2.396 11.438 2.375 14.896 55.396 40.125 88.458 104.69 88.458 172.7s-33.063 132.57-88.458 172.7c-4.771 3.458-5.833 10.125-2.375 14.896 2.083 2.875 5.344 4.406 8.646 4.406 2.167 0 4.354-0.656 6.25-2.031 60.906-44.125 97.271-115.15 97.271-189.97-1e-3 -74.823-36.365-145.84-97.271-189.97z"></path>
                            <path d="m314.01 108.3c-4.948-3.125-11.563-1.635-14.708 3.354-3.135 4.979-1.635 11.563 3.354 14.708 37.573 23.646 60.01 64.135 60.01 108.3s-22.438 84.656-60.01 108.3c-4.99 3.146-6.49 9.729-3.354 14.708 2.031 3.229 5.5 4.99 9.042 4.99 1.938 0 3.906-0.531 5.667-1.635 43.822-27.583 69.989-74.812 69.989-126.36s-26.167-98.781-69.99-126.36z"></path>
          ...
          <div class="col-lg-7 ads-about">
            <h5>Объявление</h5>
            <p>Продажа малины урожая 2019 года крупным и мелким оптом: 166 актуальных объявлений от садовников Украины с прямыми контактами. «Agro-Ukraine» дает отличную возможность купить малину по выгодной цене за счет широкого выбора предложений и отсутствия посредников. Все объявления добавляются бесплатно, примерно за 1-2 мин. </p>
          </div>
        </div>
