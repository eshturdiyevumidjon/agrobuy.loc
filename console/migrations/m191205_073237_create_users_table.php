...
class m191205_073237_create_users_table extends Migration
{
    ...
    public function safeUp()
    {
        $this->createTable('{{%users}}', [
            ...
            'chesk_phone'=>$this->boolean()->comment("Проверка телефона"),
            'chesk_mail'=>$this->boolean()->comment("Проверка почту"),
            'chesk_passport'=>$this->boolean()->comment("Проверка паспорта"),
            'chesk_car'=>$this->boolean()->comment("Проверка ьашины"),
