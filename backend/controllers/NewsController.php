    ...
    public function actionUpdate($id)
    {
        ...
        if($model->load($request->post()) && $model->validate() && $model->save()) {
            ...
            return $this->render('update', [
                ...
                'titles' => $translation_title ?? null,
                'texts' => $translation_text ?? null,
                'sort_title' => $translation_sort_title ?? null,
                'sort_items' => $translation_sort_items ?? null,
                'landing_title' => $translation_landing_title ?? null,
                'landing_text' => $translation_landing_text ?? null,
                'important' => $translation_important ?? null,
                'growing_title' => $translation_growing_title ?? null,
                'growing_text' => $translation_growing_text ?? null,
                'growing_items' => $translation_growing_items ?? null,
                'description' => $translation_description ?? null,
            ]);
        }
    }
