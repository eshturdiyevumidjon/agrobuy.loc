...
class Menu extends \yii\widgets\Menu
{
    ...
    public $options = ['class' => 'nav', 'data-widget' => 'tree'];
    ...
    {
        if (isset($item['items'])) {
            $labelTemplate = '<a href="javascript:;">{icon} {label} <b class="caret pull-right"></b></a>';

            $linkTemplate = '<a href="javascript:;">{icon} {label} <b class="caret pull-right"></b>
                            </i></a>';
        } else {
