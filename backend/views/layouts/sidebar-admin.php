    ...
    <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;">
            ...
            [
                ...
                'items' => [
                    ...
                    // ['label' => 'Баннеры', 'icon' => 'bars', 'url' => ['/banner/index'],],
                    ...
                    //         ['label' => 'Теги', 'icon' => 'book', 'url' => ['/tags/index'],],
                    //         ['label' => 'Рейтинги', 'icon' => 'fas fa-th-list', 'url' => ['/reyting/index'],],
                    //         ['label' => 'Подписчики', 'icon' => 'tags', 'url' => ['/subscribes/index'],],
                    //         ['label' => 'Обратные связи', 'icon' => 'send', 'url' => ['/feedback/index'],],
                    //     ],
                    // ] ,
